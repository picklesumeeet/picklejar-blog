                ...
                >
                  <div className="flex items-stretch gap-4 h-full">
                    ...
                    <div className="w-2/5 shrink-0">
                      {post.bannerImage ? (
                        <Image src={optimizeCloudinaryUrl(post.bannerImage, { width: 400, crop: 'fill' })} alt={post.title} width={400} height={300} className="w-full h-full object-cover rounded-sm shadow-sm" />
                      ) : (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {bottomGridPosts.map(post => (
              ...
              >
                <div className="mb-3">
                  {post.bannerImage ? (
                    <Image src={optimizeCloudinaryUrl(post.bannerImage, { width: 600, crop: 'fill' })} alt={post.title} width={600} height={375} className="w-full aspect-[16/10] object-cover rounded-sm" />
                  ) : (
