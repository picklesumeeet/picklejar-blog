  ...
  return (
    <>
      <div className={`sticky top-0 left-0 w-full z-50 transition-transform duration-300 ease-in-out ${hidden ? '-translate-y-full' : 'translate-y-0'}`}>
        ...
        >
          <Link href="/" className="flex items-center" style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "26px", letterSpacing: "0.5px", whiteSpace: "nowrap" }}>
          ...
          <form onSubmit={handleSearchSubmit} className="max-w-6xl mx-auto">
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href="/search" onClick={() => setSearchOpen(false)} className="px-3 py-1.5 border border-gray-600 rounded text-sm text-gray-300 hover:text-white hover:border-gray-400 transition-colors font-sans">
                  Latest
                </Link>
                {verticals.map(v => (
                      <Link key={v._id} href={`/${v.slug}`} onClick={() => setSearchOpen(false)} className="px-3 py-1.5 border border-gray-600 rounded text-sm text-gray-300 hover:text-white hover:border-gray-400 transition-colors font-sans">
                    {v.name}
                  </Link>
                ))}
              </div>
